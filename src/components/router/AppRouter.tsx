...
//** CUSTOM LOADING ATTT PROJECT */PersonalInformation
const ListDeviceDashboard = withLoading(ListDeviceDashboardPage);
const PersonalInformation = withLoading(PersonalInformationPage);
const ManageDevice = withLoading(ManageDevicePage);
    ...
    <BrowserRouter>
      <Routes>
        <Route path={NFT_DASHBOARD_PATH} element={protectedLayout}>
          <Route index element={<ListDeviceDashboard />} />
          <Route path="list-devices" element={<ManageDevice />} />
